...
class RxDataInfo(ctypes.Structure):
    _fields_ = [("Jnt", ctypes.c_double * 7), ("Mat", ctypes.c_double * 16), ("State", ctypes.c_double)]


class TCPoff(ctypes.Structure):
    _fields_ = [('x', ctypes.c_double), ('y', ctypes.c_double), ('z', ctypes.c_double), ('rot1', ctypes.c_double),
                ('rot2', ctypes.c_double), ('rot3', ctypes.c_double)]
